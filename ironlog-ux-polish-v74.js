(function(){
  ...
  function loadSyncResilience(){if(document.querySelector('script[src*="ironlog-sync-resilience-v75.js"]'))return;const s=document.createElement('script');s.src='./ironlog-sync-resilience-v75.js?v=75';s.defer=true;document.body.appendChild(s)}
  function run(){injectCss();setVersion();improveSetFlow();reduceDuplicateHints();loadSyncResilience();}
