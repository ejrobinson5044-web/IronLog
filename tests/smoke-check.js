...
check('rest timer can schedule phone notifications', index.includes('requestRestNotificationPermission') && index.includes('SCHEDULE_REST_NOTIFICATION') && index.includes('Enable phone alerts') && sw.includes('showNotification') && sw.includes('notificationclick') && sw.includes('ironlog-v49'));
