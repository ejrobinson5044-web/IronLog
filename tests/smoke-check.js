...
check('smart rest and warmups are available', index.includes('function smartRestSeconds') && index.includes('function WarmupSheet') && index.includes('warmupSetsFor') && index.includes('formatRest') && index.includes('startRest = (label, seconds=null)'));
...
check('rest timer can schedule phone notifications', index.includes('requestRestNotificationPermission') && index.includes('SCHEDULE_REST_NOTIFICATION') && index.includes('Enable phone alerts') && sw.includes('showNotification') && sw.includes('notificationclick') && sw.includes('ironlog-v53'));
