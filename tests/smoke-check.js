...
check('routine day tap opens day preview', index.includes('function DayPreviewSheet') && index.includes('onClick={()=>onOpenDay(d, routine, label)}') && index.includes('onStart={(idx=0)=>') && index.includes('Start workout'));
